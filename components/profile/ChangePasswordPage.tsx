    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-2xl border border-border bg-secondary/50 py-3 pl-10 pr-10 text-sm outline-none transition-all placeholder:text-muted-foreground/50 focus:border-primary focus:bg-white focus:ring-2 focus:ring-primary/15"
        />
        <button
          type="button"
          onClick={() => setShow((v) => !v)}
